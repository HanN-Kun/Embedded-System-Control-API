...
from app.routers import user, embedded_system, device_access, component, sensor, sensor_reading, device_status,queries,auth,locale,user_role
...
app.include_router(device_access.router)
